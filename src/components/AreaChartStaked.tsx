...
export function AreaChartStaked() {
  ...
  return (
    ...
    <div className="flex items-center space-x-2 p-2 font-medium">
      ...
      <div className="flex items-center space-x-2 p-2 font-medium">
      <div className="w-12 h-12 rounded-md flex justify-center text-white items-center bg-blue-500"><HandCoins /></div>
      ...
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>
            Showing total accounts for the last 3 months
          </CardDescription>
        </div>
